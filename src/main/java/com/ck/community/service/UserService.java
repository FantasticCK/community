package com.ck.community.service;

import com.ck.community.dao.LoginTicketMapper;
import com.ck.community.dao.UserMapper;
import com.ck.community.entity.LoginTicket;
import com.ck.community.entity.User;
import com.ck.community.util.CommunityConstant;
...
public class UserService implements CommunityConstant {
    ...
    public int activation(int userId, String code) {
        ...
        if (!user.getActivationCode().equals(code)) return ACTIVATION_FAILURE;
